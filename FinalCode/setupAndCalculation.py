...
def expectedList(startStation, startTime, travelTimeSoFar, day_type, interval, threshold, sd, stationML, rawLine, mlType, discrete, timeML, mlTimeType, median):
...
def finalPrediction(currTime, day, interval, rawTrips, sd, stationML, mlType, discrete, timeML, mlTimeType, median):
...
#        print(rawTrips[i])
        ...
        temp_list = expectedList(startStation, convertedStartTime, travelTimeSoFar, day_type, interval, threshold, sd, stationML, rawTrips[i], mlType, discrete, timeML, mlTimeType, median)
...
finalResult = finalPrediction('07:20:00AM', '25-APR-2017', 5, currentPassengersList, True, False, 'GBC', False, False, 'GBR', False)  #endTime is one interval after the beginning of time to predict
for i in range(18):                                                                 #SD     ML  mlType  discrete timeML mlTimeType median
    tempSum = 0
